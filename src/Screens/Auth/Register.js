  ...
  return (
    <View style={{flex: 1, backgroundColor: colors.BG}}>
      <KeyboardAwareScrollView style={{padding:16}}>
        ...
        {isSended && !isAuthorized &&
        <View>
          <Text style={[textStyles.H4, textStyles.Gray10,{paddingVertical:8}]}>인증번호</Text>
          <CustomInput
        ...
        <Text style={[textStyles.H4, textStyles.Gray10,{paddingVertical:8}]}>비밀번호</Text>
        <CustomInput
        ...
        />
        <Text style={[textStyles.H4, textStyles.Gray10,{paddingVertical:8}]}>비밀번호 확인</Text>
        <CustomInput
