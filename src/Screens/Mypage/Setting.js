...
const policy = [
  ...
  {
    title: '커뮤니티 이용규칙',
    link: 'https://peppered-game-6ea.notion.site/132198f8638c4588ae9a6954dfc86133',
  },
];
...
const SetTitle = ({title}) => {
  return (
    <Text
      style={[
        textStyles.H5,
        {color: colors.Gray06, paddingHorizontal: 24, paddingVertical: 16},
      ]}>
      {title}
    </Text>
  );
      ...
      style={({pressed}) => [
        {
          ...
          backgroundColor: pressed ? colors.Gray02 : null,
        },
      ]}>
