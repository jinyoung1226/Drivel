...
const MeetChatBoard = ({
  ...
  return (
    <View style={{minHeight: minHeight}}>
      <View style={{height: 8}} />
      <Text
        style={[textStyles.B4, {color: colors.Gray04, marginHorizontal: 24}]}>
        * 커뮤니티 이용 규칙에 벗어나는 게시글은 사전 고지 없이 삭제될 수
      ...
      <View style={{height: 8}} />
      <Text style={[textStyles.H5, {marginLeft: 24, color: colors.Blue}]}>
        {meetMessageList.length}개
      </Text>
      <View style={{height: 8}} />
